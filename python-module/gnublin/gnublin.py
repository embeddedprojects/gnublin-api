...
class ECSmtp(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ECSmtp, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ECSmtp, name)
    __repr__ = _swig_repr
    CSMTP_NO_ERROR = _gnublin.ECSmtp_CSMTP_NO_ERROR
    WSA_STARTUP = _gnublin.ECSmtp_WSA_STARTUP
    WSA_VER = _gnublin.ECSmtp_WSA_VER
    WSA_SEND = _gnublin.ECSmtp_WSA_SEND
    WSA_RECV = _gnublin.ECSmtp_WSA_RECV
    WSA_CONNECT = _gnublin.ECSmtp_WSA_CONNECT
    WSA_GETHOSTBY_NAME_ADDR = _gnublin.ECSmtp_WSA_GETHOSTBY_NAME_ADDR
    WSA_INVALID_SOCKET = _gnublin.ECSmtp_WSA_INVALID_SOCKET
    WSA_HOSTNAME = _gnublin.ECSmtp_WSA_HOSTNAME
    WSA_IOCTLSOCKET = _gnublin.ECSmtp_WSA_IOCTLSOCKET
    WSA_SELECT = _gnublin.ECSmtp_WSA_SELECT
    BAD_IPV4_ADDR = _gnublin.ECSmtp_BAD_IPV4_ADDR
    UNDEF_MSG_HEADER = _gnublin.ECSmtp_UNDEF_MSG_HEADER
    UNDEF_MAIL_FROM = _gnublin.ECSmtp_UNDEF_MAIL_FROM
    UNDEF_SUBJECT = _gnublin.ECSmtp_UNDEF_SUBJECT
    UNDEF_RECIPIENTS = _gnublin.ECSmtp_UNDEF_RECIPIENTS
    UNDEF_LOGIN = _gnublin.ECSmtp_UNDEF_LOGIN
    UNDEF_PASSWORD = _gnublin.ECSmtp_UNDEF_PASSWORD
    UNDEF_RECIPIENT_MAIL = _gnublin.ECSmtp_UNDEF_RECIPIENT_MAIL
    COMMAND_MAIL_FROM = _gnublin.ECSmtp_COMMAND_MAIL_FROM
    COMMAND_EHLO = _gnublin.ECSmtp_COMMAND_EHLO
    COMMAND_AUTH_LOGIN = _gnublin.ECSmtp_COMMAND_AUTH_LOGIN
    COMMAND_DATA = _gnublin.ECSmtp_COMMAND_DATA
    COMMAND_QUIT = _gnublin.ECSmtp_COMMAND_QUIT
    COMMAND_RCPT_TO = _gnublin.ECSmtp_COMMAND_RCPT_TO
    MSG_BODY_ERROR = _gnublin.ECSmtp_MSG_BODY_ERROR
    CONNECTION_CLOSED = _gnublin.ECSmtp_CONNECTION_CLOSED
    SERVER_NOT_READY = _gnublin.ECSmtp_SERVER_NOT_READY
    SERVER_NOT_RESPONDING = _gnublin.ECSmtp_SERVER_NOT_RESPONDING
    SELECT_TIMEOUT = _gnublin.ECSmtp_SELECT_TIMEOUT
    FILE_NOT_EXIST = _gnublin.ECSmtp_FILE_NOT_EXIST
    MSG_TOO_BIG = _gnublin.ECSmtp_MSG_TOO_BIG
    BAD_LOGIN_PASS = _gnublin.ECSmtp_BAD_LOGIN_PASS
    UNDEF_XYZ_RESPONSE = _gnublin.ECSmtp_UNDEF_XYZ_RESPONSE
    LACK_OF_MEMORY = _gnublin.ECSmtp_LACK_OF_MEMORY
    TIME_ERROR = _gnublin.ECSmtp_TIME_ERROR
    RECVBUF_IS_EMPTY = _gnublin.ECSmtp_RECVBUF_IS_EMPTY
    SENDBUF_IS_EMPTY = _gnublin.ECSmtp_SENDBUF_IS_EMPTY
    OUT_OF_MSG_RANGE = _gnublin.ECSmtp_OUT_OF_MSG_RANGE
    def __init__(self, *args): 
        this = _gnublin.new_ECSmtp(*args)
        try: self.this.append(this)
        except: self.this = this
    def GetErrorNum(self): return _gnublin.ECSmtp_GetErrorNum(self)
    def GetErrorText(self): return _gnublin.ECSmtp_GetErrorText(self)
    __swig_destroy__ = _gnublin.delete_ECSmtp
    __del__ = lambda self : None;
ECSmtp_swigregister = _gnublin.ECSmtp_swigregister
ECSmtp_swigregister(ECSmtp)
cvar = _gnublin.cvar
BOUNDARY_TEXT = cvar.BOUNDARY_TEXT

class CSmtp(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CSmtp, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CSmtp, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _gnublin.new_CSmtp()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _gnublin.delete_CSmtp
    __del__ = lambda self : None;
    def AddRecipient(self, *args): return _gnublin.CSmtp_AddRecipient(self, *args)
    def AddBCCRecipient(self, *args): return _gnublin.CSmtp_AddBCCRecipient(self, *args)
    def AddCCRecipient(self, *args): return _gnublin.CSmtp_AddCCRecipient(self, *args)
    def AddAttachment(self, *args): return _gnublin.CSmtp_AddAttachment(self, *args)
    def AddMsgLine(self, *args): return _gnublin.CSmtp_AddMsgLine(self, *args)
    def DelRecipients(self): return _gnublin.CSmtp_DelRecipients(self)
    def DelBCCRecipients(self): return _gnublin.CSmtp_DelBCCRecipients(self)
    def DelCCRecipients(self): return _gnublin.CSmtp_DelCCRecipients(self)
    def DelAttachments(self): return _gnublin.CSmtp_DelAttachments(self)
    def DelMsgLines(self): return _gnublin.CSmtp_DelMsgLines(self)
    def DelMsgLine(self, *args): return _gnublin.CSmtp_DelMsgLine(self, *args)
    def ModMsgLine(self, *args): return _gnublin.CSmtp_ModMsgLine(self, *args)
    def GetBCCRecipientCount(self): return _gnublin.CSmtp_GetBCCRecipientCount(self)
    def GetCCRecipientCount(self): return _gnublin.CSmtp_GetCCRecipientCount(self)
    def GetRecipientCount(self): return _gnublin.CSmtp_GetRecipientCount(self)
    def GetLocalHostName(self): return _gnublin.CSmtp_GetLocalHostName(self)
    def GetMsgLineText(self, *args): return _gnublin.CSmtp_GetMsgLineText(self, *args)
    def GetMsgLines(self): return _gnublin.CSmtp_GetMsgLines(self)
    def GetReplyTo(self): return _gnublin.CSmtp_GetReplyTo(self)
    def GetMailFrom(self): return _gnublin.CSmtp_GetMailFrom(self)
    def GetSenderName(self): return _gnublin.CSmtp_GetSenderName(self)
    def GetSubject(self): return _gnublin.CSmtp_GetSubject(self)
    def GetXMailer(self): return _gnublin.CSmtp_GetXMailer(self)
    def GetXPriority(self): return _gnublin.CSmtp_GetXPriority(self)
    def Send(self): return _gnublin.CSmtp_Send(self)
    def SetSubject(self, *args): return _gnublin.CSmtp_SetSubject(self, *args)
    def SetSenderName(self, *args): return _gnublin.CSmtp_SetSenderName(self, *args)
    def SetSenderMail(self, *args): return _gnublin.CSmtp_SetSenderMail(self, *args)
    def SetReplyTo(self, *args): return _gnublin.CSmtp_SetReplyTo(self, *args)
    def SetXMailer(self, *args): return _gnublin.CSmtp_SetXMailer(self, *args)
    def SetLogin(self, *args): return _gnublin.CSmtp_SetLogin(self, *args)
    def SetPassword(self, *args): return _gnublin.CSmtp_SetPassword(self, *args)
    def SetXPriority(self, *args): return _gnublin.CSmtp_SetXPriority(self, *args)
    def SetSMTPServer(self, *args): return _gnublin.CSmtp_SetSMTPServer(self, *args)
CSmtp_swigregister = _gnublin.CSmtp_swigregister
CSmtp_swigregister(CSmtp)
